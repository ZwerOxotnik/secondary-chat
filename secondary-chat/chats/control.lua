...
data.chat['all'] = function()
  chats.data['all'] = {}
  chats.data['all'].send_message = function(input_message, player)
...
data.chat['surface'] = function()
  chats.data['surface'] = {}
  chats.data['surface'].send_message = function(input_message, player)
    script.raise_event(defines.events.on_console_chat, {player_index = player.index, message = input_message})
...
data.chat['faction'] = function()
  chats.data['faction'] = {}
  chats.data['faction'].send_message = function(input_message, player)
    script.raise_event(defines.events.on_console_chat, {player_index = player.index, message = input_message})
  ...
  chats.data['faction'].gui = {}
  chats.data['faction'].gui.change_list = function(gui, target, select_list, last_target)
    local items = {}
    local index = 0
...
data.chat['local'] = function()
  chats.data['local'] = {}
  chats.data['local'].send_message = function(input_message, player)
    script.raise_event(defines.events.on_console_chat, {player_index = player.index, message = input_message})
  ...
  chats.data['local'].gui.commands = {{name = 'l', description = 'secondary_chat.local-send'},{name = 'local-send', description = 'secondary_chat.local-send'}}
end

data.chat['allies'] = function()
  chats.data['allies'] = {}
  chats.data['allies'].send_message = function(input_message, player)
    script.raise_event(defines.events.on_console_chat, {player_index = player.index, message = input_message})
  ...
  chats.data['allies'].gui.commands = {{name = 'a', description = 'secondary_chat.allied-send'},{name = 'allied-send', description = 'secondary_chat.allied-send'}}
end

data.chat['admins'] = function()
  chats.data['admins'] = {}
  chats.data['admins'].send_message = function(input_message, player)
    script.raise_event(defines.events.on_console_chat, {player_index = player.index, message = input_message})
    local message
...
data.chat['private'] = function()
  chats.data['private'] = {}
  chats.data['private'].send_message = function(input_message, player)
    local drop_down = player.gui.left.table_chat.select_chat.table.select_drop_down
    local target = nil
    if drop_down.style.visible then
  ...
  chats.data['private'].gui = {}
  chats.data['private'].gui.change_list = function(gui, target, select_list, last_target)
    local items = {}
    local index = 0
    local new_selected_index
