local function send_message_pressed(event)
  ...
  if not (table_chat and table_chat.style.visible ~= false and table_chat.select_chat and table_chat.select_chat.table.print_in_chat and table_chat.top.chat_text_box) then return end
